...
void setup() {
  ...
  Serial.println(WiFi.localIP());         // Send the IP address of the ESP8266 to the computer
	 ...
	 const char* url = "https://maker.ifttt.com/trigger/tank_level/json/with/key/ptJbZEpqEFQaB5ZwcLwwBBAJ6KhmVoqpiGvrxModLOp";

	
	Serial.println("sending data to ifttt server");

	WiFiClient client;
	HTTPClient httpClient;
	httpClient.begin(client, url);
	httpClient.addHeader("Content-Type", "application/json");
	int r = httpClient.POST("value=042");
	if (r < 0){
		Serial.println(httpClient.errorToString(r));
	}
	else{
		httpClient.writeToStream(&Serial); //write response back to serial,
	}
	Serial.printf("\n[%d] status code\n\n", r);
	
/* //	String server = "https://maker.ifttt.com/trigger/tank_level/json/with/key/ptJbZEpqEFQaB5ZwcLwwBBAJ6KhmVoqpiGvrxModLOp"; */
/* 	//const char *server ="htttp://maker.ifttt.com/tank_level"; */
/* 	const char *url = "htttp://maker.ifttt.com/tank_level"; */
/* 	String httpRequestData = "value1=042"; */
/* 	httpClient.begin(client, url); */
...
/* 	Serial.println(httpResponseCode); */
	...
	/* String httpRequestData = "api_key=ptJbZEpqEFQaB5ZwcLwwBBAJ6KhmVoqpiGvrxModLOp&value1=24.25"; */
	/* int httpResponseCode = http.POST(httpRequestData); */


	
	// ESP8266 01 code for sending value via sms
	//
	 /* const int httpPort = 80;                      */
